...
import { hotProducts, categories, banners, formatPrice } from '../constants/mockData';
...
const HomeScreen = ({ navigation }) => {
  ...
  const filteredProducts = hotProducts.filter(p =>
...
const styles = StyleSheet.create({
  ...
  categoryName: { fontSize: 11, color: '#444', textAlign: 'center', fontWeight: '600' },
